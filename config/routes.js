...
const FavoriteIcon = {...tabIconStyle, type: "ionicon", name: "md-basket", size: 30, iconSize: 30, showBadge: true};
    ...
    render() {
        ...
        return (
            <Router>
                ...
                <Scene key="BMI" component={BMI} title="bodyFit" initial titleStyle={[navTitleStyle, logoStyle]}/>
